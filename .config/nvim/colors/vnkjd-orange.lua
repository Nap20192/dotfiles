...
local palettes = {
    dark = {
        ...
        lsp_hint = "#82beb7",
        syntax_blue = "#7193bd",
        syntax_blue_bright = "#94b6df",
        syntax_cyan = "#609e98",
        syntax_magenta = "#a483bd",
    },
    light = {
        bg = "#fffaf0",
        fg = "#18130d",
        ...
        lsp_hint = "#3d7772",
        syntax_blue = "#4f719c",
        syntax_blue_bright = "#6788ae",
        syntax_cyan = "#3d7772",
        syntax_magenta = "#765d8d",
    },
}
...
vim.g.colors_name = "vnkjd-orange"
